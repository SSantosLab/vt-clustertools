...
def combine(a=2):
    ...
    if a == 1:
        ...
        if (option == 'cluster' or option == 'clusters'):
            ...
            filenames = sorted(glob.glob('/data/des40.a/data/mariaeli/lambda_star/clusters/output_test_membership/lgt5_mof_clusters_*'))
            data = loadfiles(filenames) # Call function and load all data sets
            #out_dir = '/data/des40.a/data/jburgad/clusters/outputs_brian/'
            out_dir = '/data/des40.a/data/mariaeli/lambda_star/clusters/output_test_membership/'
            ...
            filenames = sorted(glob.glob('/data/des40.a/data/mariaeli/lambda_star/clusters/output_test_membership/lgt5_mof_members_*'))
            data = loadfiles(filenames) # Call function and load all data sets
            #out_dir = '/data/des40.a/data/jburgad/clusters/outputs_brian/'
            out_dir = '/data/des40.a/data/mariaeli/lambda_star/clusters/output_test_membership/'
        ...
        # For combining the standard outputs of the BMA compute_smass 

        #filenames = sorted(glob.glob('/data/des40.a/data/jburgad/clusters/outputs_antonella/lgt5_mof/lgt5_mof_stellar_masses_*'))
        filenames = sorted(glob.glob('/data/des40.a/data/mariaeli/lambda_star/clusters/output_test_stellarmass/lgt5_mof/lgt5_mof_stellar_masses_*'))
        data = loadfiles(filenames) # Call function and load all data sets
        #out_dir = '/data/des40.a/data/jburgad/clusters/outputs_antonella/lgt5_mof/'
        out_dir = '/data/des40.a/data/mariaeli/lambda_star/clusters/output_test_stellarmass/lgt5_mof/'
        outfile = out_dir + 'lgt5_mof_stellar_masses_full.fit'
