...
def combine(a=1):
    ...
    if a == 1:
        ...
        #filenames = sorted(glob.glob('/data/des40.a/data/jburgad/clusters/outputs_antonella/mocks_900_1004_stellar_masses_*'))
        filenames = sorted(glob.glob('/data/des40.a/data/mariaeli/lambda_star/clusters/output_test_stellarmass/mocks_900_1004_stellar_masses_*'))
        data = loadfiles(filenames) # Call function and load all data sets
        #out_dir = '/data/des40.a/data/jburgad/clusters/outputs_antonella/'
        out_dir = '/data/des40.a/data/mariaeli/lambda_star/clusters/output_test_stellarmass/'
        outfile = out_dir + 'mocks_900_1004_stellar_masses_full.fit'
